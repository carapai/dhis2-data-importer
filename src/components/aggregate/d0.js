        ...
        return <div>
            ...
            <Dialog
                ...
                <DialogTitle id="alert-dialog-title"
                             onClose={this.integrationStore.closeUploadDialog}>{"Upload data"}</DialogTitle>
                <DialogContent>
                ...
                <DialogActions>
                    ...
                    <Button
                        disabled={this.integrationStore.disableDownload2}
                    ...
                    <Button
                        variant="contained"
                        color="primary"
                        disabled={!this.integrationStore.dataSet.data || this.integrationStore.dataSet.data.length === 0}
